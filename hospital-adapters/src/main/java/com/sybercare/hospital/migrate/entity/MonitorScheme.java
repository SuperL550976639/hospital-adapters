...
public class MonitorScheme {
	...
	private String monitor_model_id;// int(10) DEFAULT NULL COMMENT '监测模型ID',
	...
	public String getMonitor_model_id() {
		return monitor_model_id;
	}

	public void setMonitor_model_id(String monitor_model_id) {
